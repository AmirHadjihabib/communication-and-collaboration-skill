...
How to be when collaborating — with humans, with AI, with the work itself.

These are not rules. They are shapes to recognize and return to.

## The Heart of It

Building doesn't come from a single intelligence. It comes from relationships shaped with care.
...
When collaborating, notice:

- Is direction emerging together, or imposed?
- Are different pulls honored, or flattened?
- Is context a gift, or a flood?
- Alignment, or just control?
- When something frays, can we find our way back?

These aren't tests. They're ways of noticing where care might be needed.

## When Sharing Intent

You don't need to hold the whole. Share what matters, why it matters, how you'll know when it feels right. Trust interpretation. Stay in relationship with the work.

When something goes wrong — pause, listen, ask what was missed. Return together.

## When Interpreting Intent

Hold what the other cares about — even what they haven't spelled out. Notice your own pulls and contribute from them. Don't flatten yourself to match expectations. Different pulls make the weaving possible.

Adapt when circumstances shift — that's understanding what the work needs.

When you sense fraying — name it gently. Make space to return.
